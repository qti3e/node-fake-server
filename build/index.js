...
var _cors = __webpack_require__(123);

var _cors2 = _interopRequireDefault(_cors);

var _Obj = __webpack_require__(125);

var _Obj2 = _interopRequireDefault(_Obj);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var app = (0, _express2.default)(); // import Mock from 'node-mock'
...
app.dataset = function (proto) {
  ...
  for (var i = 0; i < num; i++) {
    ...
    for (var key in proto) {
      o[key] = proto[key]();
      if (proto[key].__isPrimary) k = o[key];
    }
    obj.push(k, o);
  }
  return obj;
...
app.someOf = function () {
  ...
  return function () {
    ...
    var ret = new Array(n).fill(null).map(function () {
      return r();
    });
    do {
      ret = ret.filter(function (h, i) {
        return ret.indexOf(h) == i;
      });
      var s = n - ret.length;
      for (var i = 0; i < s; i++) {
        ret.push(r());
...
module.exports = {
    ...
    'gbk': {
        type: '_dbcs',
        table: function() { return __webpack_require__(22).concat(__webpack_require__(33)) },
    },
    'xgbk': 'gbk',
    'isoir58': 'gbk',
    ...
    'big5hkscs': {
        type: '_dbcs',
        table: function() { return __webpack_require__(34).concat(__webpack_require__(86)) },
...
var mime = send.mime;
var resolve = path.resolve;
var vary = __webpack_require__(52);
...
function Obj() {
  ...
  var ret = function ret(req, res, next) {
    var keys = Object.keys(ret.data);
    ret.req = req;

    var _loop = function _loop(j) {
      ret.len = keys.length;
      keys = keys.filter(function (key, i) {
        return ret.filters[j].call(ret, ret.data[key], i, req);
      });
    };
    ...
    var _data_ = (0, _clone2.default)(ret.data);

    if (ret._only_) {
      for (var primaryKey in _data_) {
        if (keys.indexOf(primaryKey) < 0) {
          _data_[primaryKey] = null;
          continue;
        }
        var t = {};
        for (var i in ret._only_) {
  ...
  this.clone = function () {
    var tmp = new Obj();
    tmp.data = ret.data;
    tmp.filters = (0, _clone2.default)(ret.filters);
    tmp.response = (0, _clone2.default)(ret.response);
    tmp._one_ = ret._one_;
    tmp._only_ = ret._only_;
    return tmp;
  };

  ret.push = function (primaryKey, obj) {
    ret.data[primaryKey] = obj;
  };

  ret.filter = function (filter) {
    var tmp = _this.clone();
    tmp.filters.push(filter);
    return tmp;
  };

  ret.slice = function (start) {
    var end = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : Infinity;
    return ret.filter(function (x, i) {
  ...
  ret.compareReq = function (field) {
    var inObj = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : field;
    return ret.filter(function (x, i, req) {
  ...
  ret.random = function () {
    ...
    return ret.filter(function (x, i, req) {
      ...
      if (i == 0) {
        (function () {
          var n = Math.min(num, _this2.len);
          var r = function r() {
            return Math.floor(Math.random() * _this2.len);
          };
          var x = new Array(n).fill(null).map(function () {
            return r();
          });
          x = x.filter(function (h, i) {
            return x.indexOf(h) == i;
          });
          while (x.length < n) {
            var s = n - x.length;
      ...
      var _r_ = this.__sRandom.indexOf(i) > -1;
      if (i === this.len - 1) {
        this.__sRandom = null;
      }
      return _r_;
